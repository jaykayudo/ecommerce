...
class Address(models.Model):
    ...
    address_1 = models.CharField("Address 1",max_length=60)
    address_2 = models.CharField("Address 2",max_length=60,blank=True)
    zip_code = models.CharField("Zip/ Postal code",max_length=12)
    city = models.CharField(max_length=60)
    country = models.CharField(max_length=3,choices=Supported_Countries)
    def __str__(self):
        return ", ".join([self.name,self.address_1,self.zip_code,self.city,self.country])
...
class Basket(models.Model):
    ...
    def create_order(self, billing_address, shipping_address):
        ...
        "billing_address1": billing_address.address_1,
